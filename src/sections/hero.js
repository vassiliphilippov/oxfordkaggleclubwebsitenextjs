            ...
            <div className="mx-auto max-w-screen-xl text-center">
                <div className="py-5 px-4 sm:pt-28 lg:pt-32 lg:px-12">
                    ...
                    <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                        ...
                        >
                            <button
                                className="items-center py-3 px-10 text-xs md:text-base font-medium text-center border border-teal-700 hover:transition hover:duration-200 hover:ease-in text-white rounded-lg bg-teal-700 hover:bg-white hover:text-gray-800"
                            >
                        ...
                        <a href={heroContent.applyLink}>
                            <button
                                className="inline-flex justify-center items-center py-3 px-10 text-xs md:text-base font-medium text-center text-gray-900 border rounded-lg border-teal-700 hover:bg-teal-700 hover:text-white hover:transition hover:duration-200 hover:ease-in"
                            >
